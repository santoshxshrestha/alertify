use super::types::IconEntry;

pub static STD_ACTION_ICONS: &[IconEntry] = &[
    (
        "address-book-new",
    ...
    (
        "document-save",
        "The icon for the save action. Should be an arrow pointing down and toward a hard disk.",
    ),
    ("document-save-as", "The icon for the save as action."),
    (
        "document-send",
        "The icon for the send action. Should be an arrow pointing up and away from a hard disk.",
    ),
    ...
    (
        "find-location",
        "The icon used for the action of finding the user's physical location",
    ),
